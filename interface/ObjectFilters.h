...
enum ElectronIdArbitrations { EID_VETO, EID_LOOSE, EID_MEDIUM, EID_TIGHT, EID_CONVERSIONVETO, EID_EOPCUT, EID_TRIGGER2011, EID_TIGHTTRIGGER, EID_ECALDRIVEN, EID_TRACKERDRIVEN, EID_HEEP};
