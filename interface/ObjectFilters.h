...
enum ElectronIdArbitrations { EID_VBTF2011=0, EID_VETO, EID_LOOSE, EID_MEDIUM, EID_TIGHT, EID_CONVERSIONVETO, EID_EOPCUT, EID_TRIGGER2011, EID_TIGHTTRIGGER, EID_ECALDRIVEN, EID_TRACKERDRIVEN, EID_HEEP};
...
enum JetIdArbitrations      { JETID_LOOSE=0,           JETID_TIGHT=1, 
			      //JETID_MIN_TIGHT=4,       JETID_MIN_MEDIUM=5,       JETID_MIN_LOOSE=6, //CMGTools/External/python/pujetidproducer_cfi.py changed
			      JETID_OPT_TIGHT=4,       JETID_OPT_MEDIUM=5,       JETID_OPT_LOOSE=6,
			      JETID_CUTBASED_TIGHT=8, JETID_CUTBASED_MEDIUM=9, JETID_CUTBASED_LOOSE=10};
