...
import ROOT
ROOT.gSystem.Load('${CMSSW_BASE}/lib/${SCRAM_ARCH}/libCMGToolsHiggsAna2l2v.so')
...
os.system('cp ${CMSSW_BASE}/src/CMGTools/HiggsAna2l2v/data/html/index.html ' + outputDir)
